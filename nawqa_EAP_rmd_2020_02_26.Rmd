...
# TN, TP
plot(density(log10(dat$TN_mc)),xlab="",main="",ylim=c(0,1.5),xlim=c(-3,2),lwd=3,col="white",xaxt="n",ylab="",zero.line=FALSE)
...
text(-1.5,1.39,"Benthic algae",cex=1.25)
text(-1.5,1.22,"Macroinv.",cex=1.25)
text(-1.2,1.05,"Fish",cex=1.25)

arrows(-0.65,1.39,log10(1.169),1.39,length=0.04)
arrows(-0.85,1.22,log10(1.92),1.22,length=0.04)
arrows(-0.85,1.05,log10(1.92),1.05,length=0.04)

abline(v=median(log10(dat$TN_mc)),lty=2,lwd=1)
mtext("a",at=1.75)


plot(density(log10(dat$TP_mc)),xlab="",main="",ylim=c(0,1.5),xlim=c(-3,2),lwd=3,col="white",xaxt="n",ylab="",zero.line=FALSE)
...
text(-2.3,1.39,"Benthic algae",cex=1.25)
text(-2,1.22,"Macroinv.",cex=1.2)
text(-2,1.05,"Fish",cex=1.25)

arrows(-1.5,1.39,log10(0.074),1.39,length=0.05)
arrows(-1.3,1.22,log10(0.15),1.22,length=0.05)
arrows(-1.6,1.05,log10(0.139),1.05,length=0.05)

abline(v=median(log10(dat$TP_mc)),lwd=1,lty=2)
mtext("b",at=1.75)


plot(log10(dat$TN_mc)~log10(dat$TP_mc),cex=0.001,ylim=c(-4,2),xlim=c(-4,2),ylab="",xaxt="n",yaxt="n",xlab="",col="white")
axis(side=1,at=c(-3,-2,-1,0,1,2),labels=c(0.001,0.01,0.1,1,10,100))
axis(side=2,at=c(-3,-2,-1,0,1,2),labels=c(0.001,0.01,0.1,1,10,100))
mtext("TP (mg/L)",side=1,line=2.5,cex=1)
mtext("TN (mg/L)",side=2,line=2.5,cex=1)
rect(log10(0.074),-5,5,5,col=alpha("red",0.5),border="transparent")
rect(-5,log10(1.169),5,5,col=alpha("red",0.5),border="transparent")
rect(log10(0.15),-5,5,5,col=alpha("red",0.5),border="transparent")
rect(-5,log10(1.92),5,5,col=alpha("red",0.5),border="transparent")
rect(log10(0.139),-5,5,5,col=alpha("black",0.5),border="transparent",density=40)
rect(-5,log10(1.83),5,5,col=alpha("black",0.5),border="transparent",density=40,angle=-45)
abline(a=log10(7.2),b=log10(7.2))
points(log10(dat$TN_mc)~log10(dat$TP_mc),cex=0.1)
mtext("c",at=1.5)

# DIN, DIP
plot(density(log10(dat$DIN)),xlab="",ylab="",main="",ylim=c(0,1.5),xlim=c(-3,2),lwd=3,col="white",xaxt="n",zero.line=FALSE)
...
text(1.25,1.39,"Algal growth",cex=1.25)
text(1.25,1.19,"Litter breakdown",cex=1.25)

arrows(0.35,1.39,log10(0.186),1.39,length=0.05)
arrows(0.25,1.19,log10(0.052),1.19,length=0.05)

mtext("d",at=1.75)


plot(density(log10(dat$DIP_mc)),xlab="",ylab="",main="",ylim=c(0,1.5),xlim=c(-3,2),lwd=3,col="white",xaxt="n",zero.line=FALSE)
...
arrows(0.35,1.39,log10(0.0042),1.39,length=0.05)
arrows(0.25,1.19,log10(0.021),1.19,length=0.05)

mtext("e",at=1.75)

plot(log10(dat$DIN)~log10(dat$DIP_mc),cex=0.001,ylim=c(-4,2),xlim=c(-4,2),ylab="",xaxt="n",yaxt="n",xlab="",col="white")
axis(side=1,at=c(-3,-2,-1,0,1,2),labels=c(0.001,0.01,0.1,1,10,100))
axis(side=2,at=c(-3,-2,-1,0,1,2),labels=c(0.001,0.01,0.1,1,10,100))
mtext("DIP (mg/L)",side=1,line=2.5,cex=1)
mtext("DIN (mg/L)",side=2,line=2.5,cex=1)
#rect(log10(0.005),log10(0.016),log10(0.021),log10(0.052),col=alpha("gray",0.5),lwd=3)
rect(-5,log10(0.186),5,5,col=alpha("red",0.5),border="transparent")
rect(log10(0.0042),-5,5,5,col=alpha("red",0.5),border="transparent")
rect(-5,log10(0.052),5,5,col=alpha("red",0.5),border="transparent")
rect(log10(0.021),-5,5,5,col=alpha("red",0.5),border="transparent")
...
# PN, PP
plot(density(log10(dat$samp_PNcorr)),ylab="",xlab="",main="",ylim=c(0,1.5),xlim=c(-3,2),lwd=3,col="black",xaxt="n",zero.line=FALSE)
...
plot(density(log10(dat$samp_PPcorr)),xlab="",ylab="",main="",ylim=c(0,1.5),xlim=c(-3,2),lwd=3,col="black",xaxt="n",zero.line=FALSE)
...
plot(log10(dat$samp_PNcorr)~log10(dat$samp_PPcorr),cex=0.1,ylim=c(-4,2),xlim=c(-4,2),ylab="",xaxt="n",yaxt="n",xlab="")
axis(side=1,at=c(-3,-2,-1,0,1,2),labels=c(0.001,0.01,0.1,1,10,100))
axis(side=2,at=c(-3,-2,-1,0,1,2),labels=c(0.001,0.01,0.1,1,10,100))
mtext("PP (mg/L)",side=1,line=2.5,cex=1)
...
legend("bottom",c("DIN:DIP","PN:PP"),col=c(1,16),pch=c(1,1),cex=1.25,horiz=FALSE,inset=0.01)
