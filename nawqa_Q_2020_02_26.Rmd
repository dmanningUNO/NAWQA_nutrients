...
#par(xpd=FALSE)
plot(DINDIP_Q_landuse_v1$slope_diffs~DINDIP_Q_landuse_v1$pAG,xlab="",ylab="log-log slope",cex=1,cex.lab=1.5,cex.axis=1.5,xlim=c(0,100),pch=19)
abline(h=0)
mtext("a",at=99)

plot(DINDIP_Q_landuse_v1$slope_diffs~DINDIP_Q_landuse_v1$pURB,xlab="",ylab="",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,main="Dissolved N:P",xlim=c(0,100))
abline(h=0)
mtext("b",at=99)

plot(DINDIP_Q_landuse_v1$slope_diffs~DINDIP_Q_landuse_v1$pFOR,xlab="",ylab="",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,xlim=c(0,100))
abline(h=0)
mtext("c",at=99)

plot(TNTP_Q_landuse_v1$slope_diffs~TNTP_Q_landuse_v1$pAGR,xlab="",ylab="log-log slope",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,xlim=c(0,100))
abline(h=0)
mtext("d",at=99)
plot(TNTP_Q_landuse_v1$slope_diffs~TNTP_Q_landuse_v1$pURB,xlab="",ylab="",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,main="Total N:P",xlim=c(0,100))
abline(h=0)
mtext("e",at=99)
...
plot(PNPP_Q_landuse_v1$slope_diffs~PNPP_Q_landuse_v1$pAGR,xlab="% agriculture",ylab="log-log slope",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,xlim=c(0,100))
abline(h=0)
mtext("g",at=99)
plot(PNPP_Q_landuse_v1$slope_diffs~PNPP_Q_landuse_v1$pURB,xlab="% urban",ylab="",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,main="Particulate N:P",xlim=c(0,100))
abline(h=0)
mtext("h",at=99)
plot(PNPP_Q_landuse_v1$slope_diffs~PNPP_Q_landuse_v1$pFOR,xlab="% forest",ylab="",cex=1,pch=19,cex.lab=1.5,cex.axis=1.5,xlim=c(0,100))
abline(h=0)
mtext("i",at=99)
